...
import { useGetDashEnseignant, useGetDashFilters } from "../../../../hooks/useDashboard";
...
export const EnseignantDashboard: React.FC = () => {
  ...
  const { data: filters, isLoading: filtersLoading, isError: filtersError } = useGetDashFilters();
